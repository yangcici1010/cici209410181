function changeVideo(index) {
    ...
    switch (index) {
        case 1:
            p.innerHTML =
                '<iframe width="560" height="315" src="https://www.oxxostudio.tw/articles/201501/css-flexbox.html" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>'
            break;
        case 2:
            p.innerHTML =
